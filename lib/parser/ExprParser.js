...
var symbolicNames = [ null, null, null, null, null, null, null, null, null, 
                      null, null, "ID", "NEWLINE", "COMMENT", "WS" ];
...
function BlankExContext(parser, ctx) {
	ExprContext.call(this, parser);
    ExprContext.prototype.copyFrom.call(this, ctx);
    return this;
}

BlankExContext.prototype = Object.create(ExprContext.prototype);
BlankExContext.prototype.constructor = BlankExContext;

ExprParser.BlankExContext = BlankExContext;

BlankExContext.prototype.NEWLINE = function() {
    return this.getToken(ExprParser.NEWLINE, 0);
};
BlankExContext.prototype.accept = function(visitor) {
    if ( visitor instanceof ExprVisitor ) {
        return visitor.visitBlankEx(this);
    } else {
        return visitor.visitChildren(this);
    }
};
...
ExprParser.prototype.expr = function(_p) {
    ...
    try {
        ...
        case ExprParser.ID:
            ...
            if((((_la) & ~0x1f) == 0 && ((1 << _la) & ((1 << ExprParser.T__1) | (1 << ExprParser.ID) | (1 << ExprParser.NEWLINE))) !== 0)) {
                this.state = 16;
                this.exprList();
            }
        ...
        case ExprParser.NEWLINE:
            localctx = new BlankExContext(this, localctx);
            this._ctx = localctx;
            _prevctx = localctx;
            this.state = 24;
